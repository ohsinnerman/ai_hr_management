...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[12rem] overflow-hidden rounded-lg border border-gray-100 bg-white p-1 shadow-lg',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn('px-2.5 py-2 text-sm font-semibold', className)} {...props} />
));
